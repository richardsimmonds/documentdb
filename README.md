...
- Ready to use vector search, geospatial queries, or full-text search? See [docs/search-guide.md](docs/search-guide.md) for index creation, sample queries, and parameter references.
